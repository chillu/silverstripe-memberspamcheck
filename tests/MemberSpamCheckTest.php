...
class MemberSpamCheckTest extends SapphireTest
{
    ...
    public static $fixture_file = 'memberspamcheck/tests/MemberSpamCheckTest.yml';
    ...
    public function testCheckStopForumSpam()
    {
    ...
    public function testGetScoreFromFrequency()
    {
